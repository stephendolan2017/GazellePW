...
<Heading4 id="2.1.1">2.1.1. **File/Folder names should follow the following format**</Heading4>

<strong><a style="color:#C0392B;">[Festival/Event]</a>, <a style="color:#8E44AD;">[Venue]</a>, <a style="color:#3498DB;">[Town/City]</a>, <a style="color:#27AE60;">[Country]</a></strong><br><br>

eg. <i><a style="color:#C0392B;">Glastonbury Festival</a>, <a style="color:#8E44AD;">Worthy Farm</a>, <a style="color:#3498DB;">Pilton</a>, <a style="color:#27AE60;">England</a></i><br>

or</br>

eg. <i><a style="color:#C0392B;">X Factor Final</a>, <a style="color:#8E44AD;">Mediolanum Forum di Assago</a>, <a style="color:#3498DB;">Assago</a>, <a style="color:#27AE60;">Italy</a></i><br><br>

Normal tour dates or non festival/event dates can be titled without the <a style="color:#C0392B;">[Festival/Event]</a> tag.<br>

eg. <i><a style="color:#8E44AD;">Stade de France</a>, <a style="color:#3498DB;">Saint-Denis</a>, <a style="color:#27AE60;">France</a></i><br><br>

Visit <a href='https://setlist.fm' target='_blank'>setlist.fm</a> if you are unsure of any venue information. Do your research and make sure this is all correct!
