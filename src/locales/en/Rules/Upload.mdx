...
<Heading4 id="2.1.2">2.1.2. **Interviews:** </Heading4>

<Heading4 id="2.1.2.1">2.1.2.1. Folders, audio/video files and MD5 checksums should use the following naming scheme: [yyyy-mm-dd] - [Band Member/s] - [Radio show/Podcast] eg. 2021-10-15 - Chris Martin and Jonny Buckland - Hometime with Bush on Absolute Radio</Heading4>

<Heading4 id="2.1.2.2">2.1.2.2. Similarly, an info.txt file must accompany any interviews showing band member/s, radio show/podcast, date, lineage, audio/video info, show description, notes and media info.</Heading4>
